<template>
	<view class="chat">
					...
					<view class="chat-item__left-right">
						...
						<view class="chat-item__left-bottom">
							<view class="chat-item__left-message" @longtap="copy(item.answer)">
								...
								<text v-show="item.answer != 'error'"> {{item.answer || '思考中...'}}</text>
		...
		<view class="seize" style="height:100rpx">

		</view>
		<view class="send">
			<u--input placeholder="请输入内容" border="surround" v-model="problem"></u--input>
