<template>
	<n-page>
		<view class="chat">
			<view class="index n-flex-col n-col-center n-row-between" v-if="chat.length === 0">
				<image style="margin-top: 75rpx;width: 147rpx;height: 147rpx;"
					src="../../../static/chat/chat_2/1开始对话/机器人logo当中.png" />
				<image style="margin-top:50rpx;width: 245rpx;height: 45rpx;"
					src="../../../static/chat/chat_2/1开始对话/我能做什么？.png" />
				<image style="margin-top:55rpx;width: 668rpx;height: 160rpx"
					src="../../../static/chat/chat_2/1开始对话/功能1.png" />
				<image style="margin-top:20rpx;width: 668rpx;height: 160rpx"
					src="../../../static/chat/chat_2/1开始对话/功能2.png" />
				<image style="margin-top:20rpx;width:  668rpx;height: 160rpx"
					src="../../../static/chat/chat_2/1开始对话/功能3.png" />
				<image style="margin-top:20rpx;width:  380rpx;height: 30rpx"
					src="../../../static/chat/chat_2/1开始对话/以上，只是我的部分功能举例.png" />
			</view>
			...
			<scroll-view scroll-y="true" v-else class="chat-main" :scroll-into-view="scrollId"
						...
						<view class="chat-item__left u-flex">
							...
							<view class="chat-item__left-right">
								...
								<view class="chat-item__left-bottom">
									...
									<!-- #ifdef H5 -->
									<view
										style="margin-left:20rpx;display: flex;flex-direction: column;justify-content: center;align-items: center;height: 100%;">
										<image style="margin-top:20rpx;width: 40rpx;height: 40rpx"
											@tap="copy(item.content)"
											src="../../../static/chat/chat_2/生成回复中/停止生成按钮/复制.png" mode=""></image>
			...
			<!-- #endif -->
			<!-- 占位用的 -->
			<view :style="{height: `${commonProblem.length > 0 ? '300rpx' : '200rpx'}`,opacity: 1}">
				<view>
			...
			<view class="send" :class="{
				...
				<view class="send-line">
					...
					<view class="send-line-input" :class="{ BigInput: problem.length == 0 && list.length > 0}">
						<textarea :class="{
							focus:focus
						}" :adjust-position="false" @focus="inputFocus" @blur="inputBlur" :show-confirm-bar="false" maxlength="1000"
							placeholder="随便问点什么" auto-height v-model="problem" onfirm-type="send" @confirm="getAnswer()"
					...
					<image @tap="!chatLoading && getAnswer()" style="width: 110rpx;height: 110rpx"
						src="../../../static/chat/chat_2/1开始对话/bottom-发送.png" mode=""></image>
				</view>
				<view :style="{'min-height': keyboardHeight,height:'auto'}">
