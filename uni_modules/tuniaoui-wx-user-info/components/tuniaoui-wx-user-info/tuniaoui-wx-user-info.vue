		...
		<view class="wam__wrapper">
			...
			<view class="wam__nickname">
				<view class="nickname__data">
					<input class="input" type="nickname" :value="userInfo.nickname" @change="changeNickname" placeholder="请输入昵称"
			...
			<!-- 保存按钮 -->
			<view class="wam__submit-btn" hover-class="tn-btn-hover-class" :hover-stay-time="150" @tap.stop="submitUserInfo">
				保 存
			</view>
		</view>
	</view>
